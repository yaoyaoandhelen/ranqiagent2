  ...
  <div class="shell">
    ...
    <main>
      ...
      <section class="card section" id="treemap">
        ...
        <div class="legend">
          <span><i class="swatch" style="background:#7CC7E8"></i>评审总数低</span>
          <span><i class="swatch" style="background:#A58BE6"></i>评审总数中</span>
          <span><i class="swatch" style="background:#F29A8E"></i>评审总数高</span>
