...
<body>
  <div class="shell">
    ...
    <main>
      ...
      <section class="card section" id="treemap">
        ...
        <div class="legend">
          <span><i class="swatch" style="background:#38BDF8"></i>评审总数低</span>
          <span><i class="swatch" style="background:#8B5CF6"></i>评审总数中</span>
          <span><i class="swatch" style="background:#FF7A59"></i>评审总数高</span>
          <span>面积=该成果名称评审总数；评审总数不同，颜色不同</span>
        </div>
  ...
  <script>
    ...
    function treemapColor(total, minTotal, maxTotal) {
      ...
      const saturation = 76 + ratio * 6;
      const lightness = 54 + ratio * 7;
